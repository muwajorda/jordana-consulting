...
st.title("🧬 Bioinformatics Readiness & Workflow Generator")
st.caption("Readiness Scoring, Cloud Cost Estimation & Pipeline Builder")
...
with tab1:
    ...
    if submitted:
        ...
        st.success("Assessment Computed! Check the 'Pipeline Generator' tab for your code.")
...
sample_01,s3://my-bucket/fastqs/sample_01_R1.fastq.gz,s3://my-bucket/fastqs/sample_01_R2.fastq.gz,false
